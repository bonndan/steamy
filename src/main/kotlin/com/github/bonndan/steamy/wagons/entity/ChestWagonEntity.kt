...
class ChestWagonEntity(entityType: EntityType<out MinecartChest>, level: Level) : MinecartChest(entityType, level),
    LinkableCart<ChestWagonEntity> {
    ...
    override fun getDropItem(): Item {
        return ModItems.CHEST_WAGON.get()
    }

    override fun getPickResult(): ItemStack {
        return ItemStack(ModItems.CHEST_WAGON.get())
    }
    ...
    companion object {
        ...
        val DOMINANT_ID: EntityDataAccessor<Int> = defineId<Int>(ChestWagonEntity::class.java, INT)
        val DOMINATED_ID: EntityDataAccessor<Int> = defineId<Int>(ChestWagonEntity::class.java, INT)
    }
